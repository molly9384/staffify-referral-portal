...
import {
  ...
  addVA, terminateVA, setEligibleVA
} from '../../api/client'
    ...
    <div className="p-8 space-y-6 max-w-5xl">
      ...
      <div className="card">
        <div className="card-header flex items-center justify-between">
          ...
          <button onClick={() => setShowAddVAModal(true)} className="btn-primary text-xs px-3 py-1.5">
            Add VA
          </button>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <form onSubmit={handleAddVA} className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-2">
                <button type="button" onClick={() => setShowAddVAModal(false)} className="btn-secondary flex-1 justify-center">Cancel</button>
                <button type="submit" disabled={submitting} className="btn-primary flex-1 justify-center">{submitting ? 'Adding…' : 'Add VA'}</button>
              </div>
            </form>
          </div>
        </div>
