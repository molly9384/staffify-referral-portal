...
export default function Settings() {
  ...
  const tabs = [
    ...
    ...(isAdminOrOwner ? [{ id: 'integrations', label: 'Integrations' }] : []),
    ...(isAdminOrOwner ? [{ id: 'emails', label: 'Test Emails' }] : []),
  ]
  ...
  return (
    <div className="p-4 sm:p-8 max-w-2xl">
      ...
      <div className="flex gap-1 border-b border-gray-200 mb-6">
        {tabs.map((tab) => (
          <button
            ...
            className={`px-4 py-2.5 text-sm font-medium rounded-t-md transition-colors -mb-px border-b-2 ${
              activeTab === tab.id
      ...
      {/* Test Emails Tab */}
      {activeTab === 'emails' && isAdminOrOwner && (
        <div className="card">
          <div className="card-header">
            <div>
